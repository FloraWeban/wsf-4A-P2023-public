...
/*
  Objectif : le serveur doit contenir certaines routes effectuant des actions précises
*/
describe('the server works as expected', () => {
  ...
  /*
    Objectifs : maitriser les méthodes de l'objet `res` (la `Server Response`)
    Ainsi que les données JSON
  */
  describe('GET /', () => {
    const url = '/'
  ...
  /*
    Objectifs: maitriser les propriétés de l'objet `req` (la `Client Request`)
  */
  describe('GET /hello', () => {
    const url = '/hello'
  ...
  */
  ...
  /*
    Objectifs: maitriser les paramètres d'URL
  */
  ...
  /*
    Objectifs : créer une première route POST qui accepte un `body``
  */
...
/*
  Objectifs : Contrôler la sécurité du code
*/
...
/*
  Objectifs : Contrôler la qualité du code
*/
